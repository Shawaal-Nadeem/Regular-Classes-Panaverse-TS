...
function mul(myNumber1, myNumber2) {
    return myNumber1 * myNumber2;
}
function sub(myNumber1, myNumber2) {
    return myNumber1 - myNumber2;
}
function div(myNumber1, myNumber2) {
    return myNumber1 / myNumber2;
}
//Arrow Function
const sum1 = (myNumber1, myNumber2) => myNumber1 + myNumber2;
const mul1 = (myNumber1, myNumber2) => {
    //if we have multiple statements in arrow function then we use return in this case. Otherwise no return need.
    console.log('Hy');
    return myNumber1 * myNumber2;
};
const sub1 = (myNumber1, myNumber2) => myNumber1 - myNumber2;
const div1 = (myNumber1, myNumber2) => myNumber1 / myNumber2;
